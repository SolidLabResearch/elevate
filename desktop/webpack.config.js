...
const copyOxigraphWasmPlugin = {
  apply(compiler) {
    compiler.hooks.afterEmit.tap("CopyOxigraphWasmPlugin", () => {
      const source = path.resolve(__dirname, "../appcore/node_modules/oxigraph/node_bg.wasm");
      const target = path.resolve(compiler.options.output.path, "node_bg.wasm");
...
module.exports = [
  // Main process
  {
    ...
    plugins: [copyOxigraphWasmPlugin]
  },
